...
public class TableModelProdutos extends AbstractTableModel {
    //Adicionar coluna de preço de custo
    String[] columns = { "Nome", "Preço de Custo", "Preço de Venda", "Unidade Medida" };
    ...
    public Object getValueAt(int rowIndex, int columnIndex){
        return switch (columnIndex) {
            ...
            case 1 -> produtosModel.get(rowIndex).getPrecoCusto();
            case 2 -> produtosModel.get(rowIndex).getPrecoVenda();
            case 3 -> produtosModel.get(rowIndex).getMedida();
